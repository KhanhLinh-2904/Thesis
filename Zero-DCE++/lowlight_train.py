...
if __name__ == "__main__":
	...
	parser.add_argument('--lowlight_images_path', type=str, default="Zero-DCE++/data/train/")
	...
	parser.add_argument('--snapshots_folder', type=str, default="Zero-DCE++/snapshots_1000_Linh/")
